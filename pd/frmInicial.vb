...
Public Class frmInicial
    ...
    Private Sub T_num_p_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles T_num_p.LostFocus
        ...
        If T_num_p.TextLength = 0 Then
            Exit Sub
        End If

        Dim numero_partido, tablas As String
        Dim numero_p As DataTable = New DataTable
        conectar1()
        Cambio_Color(Me)
        numero_partido = T_num_p.Text
        ...
        Else
            ...
            End If
        End If
        'If numero_partido.Length = 0 Then
        '    tablas = "select * from partidos"
        'Else
        tablas = "select * from partidos where CODIGO='" & numero_partido & "' "
        'End If
